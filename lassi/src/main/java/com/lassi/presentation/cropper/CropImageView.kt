                    ...
                    try {
                        ...
                        CropImageOptions(
                            ...
                            circleCornerFillColorHexValue = a.getInteger(
                                R.styleable.CropImageView_ls_cropCornerCircleFillColor,
                                default.circleCornerFillColorHexValue
                            ),
                            borderLineThickness = a.getDimension(
                                R.styleable.CropImageView_ls_cropBorderLineThickness,
                                default.borderLineThickness
                            ),
                            borderLineColor = a.getInteger(
                                R.styleable.CropImageView_ls_cropBorderLineColor,
                            ...
                            borderCornerOffset = a.getDimension(
                                R.styleable.CropImageView_ls_cropBorderCornerOffset,
                                default.borderCornerOffset
                            ),
                            borderCornerLength = a.getDimension(
                                R.styleable.CropImageView_ls_cropBorderCornerLength,
                                default.borderCornerLength
                            ),
                            borderCornerColor = a.getInteger(
                                R.styleable.CropImageView_ls_cropBorderCornerColor,
                                default.borderCornerColor
                            ),
                            guidelinesThickness = a.getDimension(
                                R.styleable.CropImageView_ls_cropGuidelinesThickness,
                                default.guidelinesThickness
                            ),
                            guidelinesColor = a.getInteger(
                                R.styleable.CropImageView_ls_cropGuidelinesColor,
                                default.guidelinesColor
                            ),
                            backgroundColor = a.getInteger(
                                R.styleable.CropImageView_ls_cropBackgroundColor,
                                default.backgroundColor
                            ),
                            minCropWindowWidth = a.getDimension(
                                R.styleable.CropImageView_ls_cropMinCropWindowWidth,
                            ...
                            flipHorizontally = a.getBoolean(
                                R.styleable.CropImageView_ls_cropFlipHorizontally,
                            ...
                            showCropLabel = a.getBoolean(
                                R.styleable.CropImageView_ls_cropShowLabel,
                                default.showCropLabel
                            ),
                            maxZoom = a.getInteger(
                                R.styleable.CropImageView_ls_cropMaxZoom,
                                default.maxZoom
                            ),
                            showCropOverlay = a.getBoolean(
                                R.styleable.CropImageView_ls_cropShowCropOverlay,
                                default.showCropOverlay
                            ),
                            showProgressBar = a.getBoolean(
                                R.styleable.CropImageView_ls_cropShowProgressBar,
                            ...
                            fixAspectRatio = a.getBoolean(
                                R.styleable.CropImageView_ls_cropFixAspectRatio,
                                default.fixAspectRatio
                            ) || a.hasValue(R.styleable.CropImageView_ls_cropAspectRatioX) && a.hasValue(
                                R.styleable.CropImageView_ls_cropAspectRatioX
                            ),
                        )
                    } finally {
