...
public abstract class CameraController implements
    ...
    final Size getUncroppedSnapshotSize(int reference) {
        ...
        float baseRatio = AspectRatio.Companion.of(baseSize).toFloat();
        float maxValuesRatio = AspectRatio.Companion.of(maxWidth, maxHeight).toFloat();
    ...
    protected final Size computePreviewStreamSize(@NonNull List<Size> previewSizes) {
        ...
        AspectRatio targetRatio = AspectRatio.Companion.of(mCaptureSize.getWidth(), mCaptureSize.getHeight());
